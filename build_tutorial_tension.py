...
CELLS.append(md(
    ...
    "---",
    "",
    "**The short version.** Train this tiny model once and it tells you, with confidence, whether Pluto is a planet. Train it again on a fresh draw of the same data and the answer can change. This notebook is about that gap, and about the discipline it takes not to be fooled by a single run.",
    "",
